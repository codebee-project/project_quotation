                    ...
                    <section id="main-content">
                      ...
                      <div class="font-content-view-quo">
                        ...
                        <div class="col-md-12 font-navi-view-quo no-padding-lr">
                          ...
                          <a href="#"><span class="color-dark-red">Add Invoice</span></a>
                        </div>
                          
                          <!-- header -->
                        <div class="mr-header col-md-12 font-h-view-quo no-padding-lr">
                          <i class="fa fa-angle-right"></i> 
                        ...
                        <div class="col-md-12 col-sm-12 color-dark-gray-h mr-c-viewquo no-padding-lr"> 
                            ...
                            <div class="col-md-7 col-sm-7 no-padding-lr font-light">
                                <input type="text" class="form-control" name="contact" placeholder="Please enter invoice number">
                            </div>
                        ...
                        <div class="col-md-12 col-sm-12 color-dark-gray font-size-table no-padding-lr">
                            <table id="add_invoice_quo" class="table table-striped" cellspacing="0" width="100%">
                                <thead>
