                    ...
                    <section id="main-content">
                      ...
                      <div class="font-regular edit-quo-navigator">
                        ...
                        <div class="font-size-nav1">
                          ...
                          <span class="color-dark-red">Edit Quotation</span>
                        </div>
                    
                        <div class="mr-header font-regular header-edit-quo no-padding-lr">
                          <span><i class="fa fa-angle-right"></i> Edit Quotation</span>
                        </div>
                        ...
                        <div class="col-md-12 no-padding-lr font-18">
                          <form class="form">
                            ...
                            <div class="form-group mr-form-profile col-md-12 col-sm-12 no-padding-lr">
                              ...
                              <div id="sandbox-container col-sm-9 no-padding-lr">
                                <div class="col-md-9 no-padding-lr">
                                  <div class="input-group date">
                                    <input type="text" class="form-control input-datepicker" placeholder="dd/mm/yyyy" value="19/07/2017">
                            ...
                            <div class="form-group mr-form-profile col-md-12 col-sm-12 no-padding-lr">
                              ...
                              <div class="col-sm-9 no-padding-lr">
                                <input type="text" class="form-control" id="ip_quoNo" placeholder="Please enter quotation no" value="Quo-10006">
                              </div>
                            </div>
                            ...
                            <div class="form-group mr-form-profile col-md-12 col-sm-12 no-padding-lr">
                              ...
                              <div class="col-sm-9 no-padding-lr font-17 font-light">
                                <label class="radio-inline rdo-edit">
