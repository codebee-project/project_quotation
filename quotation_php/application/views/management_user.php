...
<section id="main-content">
    ...
    <div class="wrapper font-content-view-quo">
        ...
        <div class="col-md-12 col-sm-12 mr-search no-padding-lr">
            ...
            <div class="col-md-2 col-sm-3 no-padding-r no-pd-l">
                <a href="add_user.html" type="button" id="search_quo" class="btn btn-add">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="width-td-status">
                            <a href="view_user.html" class="btn btn-view font-light">View</a>
                        </td>
                    </tr>
                    <tr>
                        <td>02</td>
