                ...
                <div class="col-lg-12">
                    ...
                    <section id="main-content">
                        ...
                        <div class="font-size-nav1">
                            ...
                            <a href="#"><span class="color-dark-red">Add Contact</span></a>
                          </div>
                        </div>
                          ...
                          <span>Add Contact</span>
                            ...
                            <div class="col-md-12 col-sm-12 color-dark-gray-h mr-c-viewquo no-padding-lr"> 
                                ...
                                <div class="col-md-7 col-sm-7 no-padding-lr font-light">
                                    <input type="text" class="form-control" name="contact" placeholder="Please enter contact name">
                                </div>
                            ...
                            <div class="col-md-12 col-sm-12 color-dark-gray font-size-table no-padding-lr">
                                <table id="add_contact_quo" class="table table-striped" cellspacing="0" width="100%">
                                    <thead>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>william.son@gmail.com</td>
                                            <td>096-5951155<br>099-2653636</td>
                                            <td><a href="#"><i class="fa fa-trash fa-2x"></i></a></td>
                                        </tr>
                                        <tr>
                                            <td>02</td>
                                            <td>Integration Specialist</td>
                                            <td>integrate.sp@gmail.com</td>
                                            <td>094-4435956</td>
                                            <td><a href="#"><i class="fa fa-trash fa-2x"></i></a></td>
                                        </tr>
                                        <tr>
