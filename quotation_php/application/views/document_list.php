...
<!-- start call url -->
<?php
  $add_document = base_url('Document/view_add_document');
  $edit_document = base_url('Document/view_edit_document');
?>
<!-- end call url -->
                      ...
                      <div class="font-content-view-quo">
                        ...
                        <div class="col-md-12 col-sm-12 mr-search no-padding-lr">
                            ...
                            <div class="col-md-3 col-sm-3 no-padding-r no-pd-l">
                                <a href="<?php echo $add_document ?>" type="button" id="search_quo" class="btn btn-add">
                        ...
                        <div class="col-md-12 col-sm-12 color-dark-gray font-size-table no-padding-lr">
                            <table id="doc_list" class="table table-striped" cellspacing="0" width="100%">
                                <thead>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="width-td-status"><a href="<?php echo $edit_document ?>"><i class="fa fa-edit fa-2x"></i></a></td>
                                    </tr>
                                    <tr>
                                        <td>02</td>
                                        <td>requirement_savedee_1</td>
                                        ...
                                        <td class="width-td-status"><a href="../../html/edit_invoice.html"><i class="fa fa-edit fa-2x"></i></a></td>
                                    </tr>
                                    <tr>
                                        <td>03</td>
                                        <td>requirement_savedee_1</td>
