                    ...
                    <section id="main-content">
                      ...
                      <div class="font-regular edit-quo-navigator">
                        <div class="font-size-navi">
                          ...
                          <span class="a-hover">
                            <a href="../../html/type_list.html" class="color-dark-gray-h">Quotation Type</a>
                          </span>
                          <i class="fa fa-angle-right"></i>
                          <span class="color-dark-red">Edit Quotation Type</span>
                        </div>
                    
                        <div class="mr-header font-regular header-edit-quo no-padding-lr">
                          <span><i class="fa fa-angle-right"></i> Edit Quotation Type</span>
                        </div>
                        ...
                        <div class="col-md-12 col-sm-12 no-padding-lr font-18">
                          <form class="form">
                            ...
                            <div class="form-group mr-form-profile col-md-12 col-sm-12 no-padding-lr">
                              ...
                              <div class="col-sm-9 no-padding-lr mr-t-input">
                                <input type="text" class="form-control" id="ip_quoType" placeholder="Please enter quotation type" value="Website">
                              </div>
                            </div>
                            
                            <div class="col-md-offset-4 col-sm-offset-2 col-sm-8 col-md-4 text-center mr-btn-profile n-pad">
